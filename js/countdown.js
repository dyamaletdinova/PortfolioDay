...
*/
var note="DMACC PORTFOLIO DAY IS TODAY!"; /* -->Enter what you want the script to
...
=======
var note="Portfolio Day!"; /* -->Enter what you want the script to
              display when the target date and time
              are reached, limit to 25 characters */
var year=2016;      /* -->Enter the count down target date YEAR */
...
d1 = new Image(); d1.src = "imgs/digital-numbers/1.png";
d2 = new Image(); d2.src = "imgs/digital-numbers/2.png";
d3 = new Image(); d3.src = "imgs/digital-numbers/3.png";
d4 = new Image(); d4.src = "imgs/digital-numbers/4.png";
d5 = new Image(); d5.src = "imgs/digital-numbers/5.png";
d6 = new Image(); d6.src = "imgs/digital-numbers/6.png";
d7 = new Image(); d7.src = "imgs/digital-numbers/7.png";
d8 = new Image(); d8.src = "imgs/digital-numbers/8.png";
d9 = new Image(); d9.src = "imgs/digital-numbers/9.png";
d0 = new Image(); d0.src = "imgs/digital-numbers/0.png";
bkgd = new Image(); bkgd.src = "imgs/digital-numbers/bkgd.gif";
